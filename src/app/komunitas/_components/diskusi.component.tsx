...
// Enhanced Community Discussion Section Component
export const CommunityDiscussionSection = () => {
  ...
  // Mock data untuk discussions
  const discussions: Discussion[] = [
    {
      id: "1",
      title: "Cara viralkan produk UMKM di TikTok dengan modal Rp 100 ribu",
      content: "Saya berhasil jual 500 pcs keripik singkong dalam 3 hari hanya dari 1 video TikTok! Rahasianya: gunakan audio trending, buka 'live' jam 8 malam, dan pakai strategi giveaway sederhana...",
      author: "Budi Martono",
  ...
  const filterOptions = ["Recently active", "Most popular", "Most viewed", "Most liked"];
  const totalPages = 78;
                ...
                <div
                  ...
                  onMouseEnter={(e) => {
                    if (!isSelected) {
                      ...
                      e.currentTarget.style.boxShadow = "0 12px 30px -8px rgba(0, 0, 0, 0.15)";
                      // Tambahkan perubahan warna border dan background
                      e.currentTarget.style.borderColor = "#FEE480";
                      e.currentTarget.style.background = `#FEE48005`; // 5% opacity dari category color
                    }
                  }}
                  onMouseLeave={(e) => {
                    if (!isSelected) {
                    ...
                    <div style={{
                      ...
                      <div style={{
                        ...
                        <category.icon 
                          size={24}
                          style={{ 
                            color: category.color === '#FDD741' || category.color === '#FEE480' ? "#111827" : "#ffffff"
                          }} 
                        />
                      </div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: "24px",
                    padding: "2rem",
                    marginBottom: index === discussions.length - 1 ? "0" : "1.5rem",
                    border: "1px solid #f1f5f9",
                    transition: "all 0.4s cubic-bezier(0.4, 0, 0.2, 1)",
                    cursor: "pointer",
                    animationDelay: `${index * 0.1}s`,
